...
st.set_page_config(page_title="Execução Mary 02")
...
with st.container():
        ...
        def send_email(to_email, to_name):
            ...
            msg['To'] = to_email
            msg['Subject'] = "99.95% de detecção de ameaças"
            ...
            <html>
                <body>
                    <p>Oi, {to_name}, tudo bem?</p>
                    <p>Gostaria de compartilhar com você um case de sucesso de uma empresa Multinacional do ramo de Energéticos. </p>
                    <p>A solução da PerceptionPoint identifica impressionantes 99,95% das ameaças, oferecendo à empresa uma proteção robusta contra ataques cibernéticos.</p>
                    <p>Ao escanear 100% dos emails que chegam à caixa de entrada, a solução garante que nenhum aspecto suspeito passe despercebido, mantendo a empresa um passo à frente dos cibercriminosos.</p>
                    <p>Com uma incrível economia de tempo de até 75% para a equipe de Operações de Segurança (SOC), a empresa de bebida energética experimentou uma eficiência operacional incomparável, permitindo-lhes concentrar seus esforços em iniciativas estratégicas.</p>
                    <p>Além disso, a solução de proteção de emails da PerceptionPoint opera com sete camadas de segurança, garantindo uma defesa completa contra ameaças digitais em todas as frentes.</p>
                    <p>Gostaria de agendar uma demonstração com você. Qual é a melhor data para falarmos?</p>
                    <p>Muito obrigada!</p>
                </body>
            </html>
            """
